window.onload = function() {
  document.getElementById("output").innerHTML =
	...
	var cdest = document.getElementById("cdes");
	cdest.addEventListener("click", designfunc,false);
	  ...
	  messageErr.innerHTML = "";
		  ...
		  sttotal = sttotal + stvingb;
			 ...
			 if (camlist.length>0) {
			        ...
			        document.getElementById("stresult").innerHTML = "you have to add some camera sets before";
			    }
	...
	function calculatetg(){
	  messageErr.innerHTML = "";
		...
		if (camlist.length>0) {
			        ...
			        document.getElementById("tgresult").innerHTML = "you have to add some camera sets before";
			    }
	}// end of calculatetg function
	function designfunc() {
			    messageErr.innerHTML ="The design option is not available for this version";
